...
actions = [
    Action(
        r("(SetOn ?e)"),
        precondition=r("(and (Edge ?e) (Unassigned ?e))"),
        additions={r("(On ?e)")},
        deletions={r("(Unassigned ?e)"), r("(not (On ?e))")},
    ),
    Action(
        r("(SetOff ?e)"),
        precondition=r("(and (Edge ?e) (Unassigned ?e))"),
        additions={r("(not (On ?e))")},
        deletions={r("(Unassigned ?e)")},
    ),
]
...
all_assigned_goal = "(and " + " ".join(f"(not (Unassigned {e}))" for e in edges) + ")"

# final goal
all_goals = [clue_goal_str] + vertex_goals + [nonempty_goal] + [all_assigned_goal]
